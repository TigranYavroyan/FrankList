#ifndef _CONST_REVERSE_MULTI_ITERATOR_HPP
#define _CONST_REVERSE_MULTI_ITERATOR_HPP
...
template <typename T>
const typename FrankList<T>::const_multi_reverse_iterator FrankList<T>::const_multi_reverse_iterator::operator++ (FrankList<T>::value_type) {
    Node *tmp = this->ptr;
    ++(*this);
...
#endif // _CONST_MULTI_REVERSE_ITERATOR_HPP